      ...
      body={
        <div className="PaddingLeftM PaddingRightM PaddingBottomXS">
          <div
            ...
            title={paymentState == 'initialized' ? t('payment.changeAmount') : undefined}
            onClick={() => {
                ...
                <div className="CardText">
                  ...
                  {salePerTokenValue &&
                    <div className="TokenAmountRow small Opacity05">
                      <span className="TokenAmountCell">{salePerTokenValue} {t('sale.perToken')}</span>
                    </div>
                  }
                </div>
              </div>
          ...
          <div
            ...
            title={paymentState == 'initialized' ? t('paymentOptions.title') : undefined}
            onClick={() => {
              if (paymentState != 'initialized') { return }
