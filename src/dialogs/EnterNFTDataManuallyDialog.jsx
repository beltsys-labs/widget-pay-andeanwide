    ...
    <Dialog
      header={
        <div className="PaddingTopS PaddingLeftM PaddingRightM">
          <div>
            <h1 className="LineHeightL FontSizeL">{t('nft.enterData')}</h1>
          </div>
              ...
              <div>
                <div className="PaddingTopXS TextLeft">
                  <label htmlFor="DePayWidgetsEnterNFTTokenAddresses">
                    <div className="FontSizeS Opacity05">{t('nft.tokenMintAddresses')}</div>
                  </label>
                </div>
              ...
              <div>
                <div className="PaddingTopXS TextLeft">
                  <label htmlFor="DePayWidgetsEnterNFTTokenAddress">
                    <div className="FontSizeS Opacity05">{t('nft.tokenContractAddress')}</div>
                  </label>
                </div>
                <div className="PaddingTopXS PaddingBottomS TextLeft">
            ...
            <div>
              <div className="PaddingTopXS TextLeft">
                <label htmlFor="DePayWidgetsEnterNFTTokenId">
                  <span className="FontSizeS Opacity05">{t('nft.tokenId')}</span>
                </label>
              </div>
              <div className="PaddingTopXS PaddingBottomS TextLeft">
          ...
          <div>
            <div className="PaddingTopXS TextLeft">
              <label htmlFor="DePayWidgetsEnterNFTName">
                <span className="FontSizeS Opacity05">{t('nft.name')}</span>
              </label>
            </div>
            <div className="PaddingTopXS PaddingBottomS TextLeft">
          ...
          <div>
            <div className="PaddingTopXS TextLeft">
              <label htmlFor="DePayWidgetsEnterNFTImage">
                <span className="FontSizeS Opacity05">{t('nft.image')}</span>
              </label>
            </div>
            <div className="PaddingTopXS PaddingBottomS TextLeft">
          ...
          <div>
            <div className="PaddingTopXS TextLeft">
              <label htmlFor="DePayWidgetsEnterNFTLink">
                <span className="FontSizeS Opacity05">{t('nft.link')}</span>
              </label>
            </div>
            <div className="PaddingTopXS PaddingBottomS TextLeft">
