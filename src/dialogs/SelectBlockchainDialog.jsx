    ...
    <Dialog
      header={
        <div className="PaddingTopS PaddingLeftM PaddingRightM PaddingBottomS">
          <div>
            <h1 className="LineHeightL FontSizeL">{t('platform.select')}</h1>
            <div className="PaddingTopS TextLeft">
              <input value={searchTerm} autoFocus={!isMobile()} onChange={onChangeSearch} className="Search" placeholder={t('platform.search')} ref={searchElement} />
            </div>
          </div>
        </div>
      }
